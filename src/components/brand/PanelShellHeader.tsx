...
type PanelShellHeaderProps = {
  trailing?: ReactNode;
  below?: ReactNode;
  /** Conteúdo à esquerda — padrão: logomarca FilaDock */
  leading?: ReactNode;
  tone?: "light" | "dark";
  logoSize?: "xs" | "sm" | "md";
    ...
    <header
      className={cn(
        ...
        dark
          ...
          : "border-slate-200/80 bg-white/95 shadow-[0_1px_0_rgb(15_23_42/0.04)]",
        className
      )}
    >
      {!dark && <div className="border-t-[3px] border-brand" aria-hidden />}
      <div
        className={cn(
          "flex items-center justify-between gap-3",
          dark ? "px-6 py-4 lg:px-8" : "page-container min-h-14 py-2.5"
        )}
      >
      ...
      {below && (
        <div
          className={cn(
            ...
            dark ? "px-6 pb-3 pt-2 lg:px-8" : "page-container pb-3 pt-2"
          )}
        >
          {below}
        </div>
