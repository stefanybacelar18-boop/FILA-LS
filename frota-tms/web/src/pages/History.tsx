  ...
  return (
    <div>
      <PageHeader
        ...
        description={
          isAdmin
            ? 'Consulta de viagens e desfazer retorno confirmado por engano (somente administrador)'
            : 'Consulta de viagens com filtros avançados'
        }
      />
                ...
                {data.map((t) => (
                  <tr key={t.id}>
                    ...
                    {isAdmin && (
                      <td>
                        {t.status === 'RETORNOU' ? (
                          <Button size="sm" variant="secondary" onClick={() => setUndoTarget(t)}>
